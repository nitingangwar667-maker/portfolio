  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Nitin Gangwar - Computer Science student at CGCU and software developer building practical, modern applications.",
      },
      {
        property: "og:title",
        content:
          "Nitin Gangwar | Computer Science Student & Software Developer",
      },
      {
