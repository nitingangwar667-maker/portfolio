...
const SERVICES = [
  {
    ...
    desc: "Developing and implementing automated solutions to streamline processes, improve efficiency, and reduce manual intervention across various systems and workflows.",
  },
  {
    n: "02",
  ...
  {
    n: "03",
    name: "Automated ioT Systems",
    desc: "Creating intelligent, automated systems that leverage IoT devices to enhance efficiency, monitoring, and control in various environments.",
  },
  {
    n: "04",
