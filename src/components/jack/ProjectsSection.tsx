...
const PROJECTS: Project[] = [
  ...
  },
  {
    n: "04",
    category: "Web",
    name: "safety and security car system",
    image: projectResponsive,
    images: [projectResponsive, projectResponsiveOne, projectResponsiveThree],
    link: "https://github.com/nitingangwar667-maker/Full_saftey_and_vehicle_control",
  },
];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        {PROJECTS.map((project, index) => (
          <div
            key={project.n}
            className="mb-10 last:mb-0 md:mb-0 md:min-h-[940px] lg:min-h-screen"
          >
            <ProjectCard
              project={project}
              index={index}
